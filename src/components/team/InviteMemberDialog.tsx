...
import { inviteTeamMemberAction } from '@/app/actions/invitationActions';
...
export function InviteMemberDialog({
  ...
  const boundAction = inviteTeamMemberAction.bind(null, {
    actorId: user?.uid ?? '',
  ...
  if (authLoading || !user || !companyProfile) {
    return (
      <DialogContent>
        <DialogHeader>
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            will appear in the team members list.
          </p>
        </div>
        <DialogFooter>
  ...
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Invite New Team Member</DialogTitle>
        <DialogDescription>
          Enter the details of the team member you want to invite. An invitation
              ...
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="resourceManager">
                      Resource Manager
                    </SelectItem>
